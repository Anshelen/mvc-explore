...
public class JDBCExample {
    ...
    @Autowired
    private DataSource dataSource; //look to application-context.xml bean id='dataSource' definition
    ...
    public List<DBLog> queryAllLogs() {
        ...
        List<DBLog> dbLogList = jdbcTemplate.query(QUERY_SQL, new RowMapper<DBLog>() {
    ...
    public List<User> queryAllUsers() {
        ...
        List<User> userList = jdbcTemplate.query(QUERY_SQL, new RowMapper<User>() {
